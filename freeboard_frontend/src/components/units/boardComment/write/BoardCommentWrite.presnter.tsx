            ...
            <WrapperComment>
                ...
                <WrapperGroup>
                    ...
                    <WrapperFooterComment> 
                        ...
                        {props.isEdit && <CommentSubmit id={props.data?._id} onClick={props.onClickUpdate} isEdit={true} >수정하기</CommentSubmit>}
                    </WrapperFooterComment> 
                </WrapperGroup>
            </WrapperComment>
        </Wrapper>
