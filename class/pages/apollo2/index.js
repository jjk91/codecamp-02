...
export default function Apollo2Page() {
    ...
    const [product] = useMutation(
        gql`
            mutation zzz ($newseller: String
                , $sellerproduct:CreateProductInput!
                ){
                createProduct(seller: $newseller
                    ,createProductInput: $sellerproduct
                    ){
                    _id
                    message
                }
    ...
    return (
        <>
            ...
            상품 상세:<input type="text" onChange={onChangeProductNameDetail}/><br/>
